...
final class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('app.platform', function () {
    ...
    {
        return $this->retrieveUsingCacheOrResolve('app.browser', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('app.desktop', function () {
