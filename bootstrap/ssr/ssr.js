...
import { LoaderCircle, Check, X, PanelLeft, ChevronRight, Circle, ChevronDown, Settings, LogOut, Menu, LayoutGrid, Files, Rows2, Zap, Folder, BookOpen, Search, Sun, Moon, Monitor, Laptop2, Phone } from "lucide-react";
...
const NavigationMenu = React.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(NavigationMenuPrimitive.Root, { ref, className: cn("relative z-10 flex max-w-max flex-1 items-center justify-center", className), ...props, children: [
  children,
...
const NavigationMenuTrigger = React.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(NavigationMenuPrimitive.Trigger, { ref, className: cn(navigationMenuTriggerStyle(), "group", className), ...props, children: [
  children,
  " ",
  /* @__PURE__ */ jsx(ChevronDown, { className: "relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180", "aria-hidden": "true" })
] }));
...
function AppLogo() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "ml-1 grid flex-1 text-left text-sm", children: /* @__PURE__ */ jsx("span", { className: "mb-0.5 truncate leading-none font-semibold", children: "Kit" }) })
  ] });
}
const mainNavItems = [
  {
      ...
      /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center space-x-2", children: [
        ...
        /* @__PURE__ */ jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "ghost", className: "size-10 rounded-full p-1", children: /* @__PURE__ */ jsxs(Avatar, { className: "size-8 overflow-hidden rounded-full", children: [
            /* @__PURE__ */ jsx(AvatarImage, { src: auth.user.profile_photo_url, alt: auth.user.name }),
...
function AppearanceToggleTab({ className, ...props }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsx(Label, { asChild: true, children: /* @__PURE__ */ jsx("p", { children: "Theme" }) }),
    /* @__PURE__ */ jsx("p", { className: "text-muted-foreground block text-[0.8rem] opacity-75", children: "Select the theme for the dashboard." }),
    /* @__PURE__ */ jsx("div", { className: cn("inline-flex gap-1 rounded-lg bg-neutral-100 p-1 dark:bg-neutral-800", className), ...props, children: tabs.map(({ value, icon: Icon2, label }) => /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
...
function HeadingSmall({ title, description }) {
  return /* @__PURE__ */ jsxs("header", { children: [
    ...
    description && /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm opacity-75", children: description })
  ] });
}
...
function General({ mustVerifyEmail, status }) {
    ...
    /* @__PURE__ */ jsxs(SettingsLayout, { children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "name", children: "Name" }),
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground block text-[0.8rem] opacity-75", children: "Your full name." }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "name",
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "email", children: "Email address" }),
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground block text-[0.8rem] opacity-75", children: "The email address used for authentication and notifications." }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "email",
    ...
    /* @__PURE__ */ jsx(SettingsLayout, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: updatePassword, className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-muted-foreground block text-[0.8rem] opacity-75", children: "You must confirm your current password to make changes." }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "current_password",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-muted-foreground block text-[0.8rem] opacity-75", children: "Passwords must be at least 12 characters." }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "password",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "password_confirmation", children: "Confirm password" }),
          /* @__PURE__ */ jsx("span", { className: "text-muted-foreground block text-[0.8rem] opacity-75", children: "Enter your new password again." }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "password_confirmation",
...
function BrowserSessions({ sessions }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsx(HeadingSmall, { title: "Browser Sessions", description: "Manage and logout your active sessions on other browsers and devices" }),
    /* @__PURE__ */ jsx(Separator, {}),
    sessions.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-5 space-y-4", children: sessions.map((session, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
      session.agent.is_desktop ? /* @__PURE__ */ jsx(Laptop2, {}) : /* @__PURE__ */ jsx(Phone, {}),
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500", children: [
          session.ip_address,
          ",",
          session.is_current_device ? /* @__PURE__ */ jsx("span", { className: "font-semibold text-green-500", children: " This device" }) : /* @__PURE__ */ jsxs("span", { children: [
            " Last active ",
            session.last_active
          ] })
        ] })
    ...
    /* @__PURE__ */ jsxs(Dialog, { children: [
      /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "destructive", children: "Log Out Other Browser Sessions" }) }),
      /* @__PURE__ */ jsxs(DialogContent, { children: [
        ...
        /* @__PURE__ */ jsxs("form", { className: "space-y-6", onSubmit: logoutOtherBrowserSessions, children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "password", className: "sr-only", children: "Password" }),
            /* @__PURE__ */ jsx(
              Input,
          ...
          /* @__PURE__ */ jsxs(DialogFooter, { children: [
            /* @__PURE__ */ jsx(DialogClose, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "secondary", onClick: closeModal, children: "Cancel" }) }),
            /* @__PURE__ */ jsx(Button, { variant: "destructive", disabled: processing, asChild: true, children: /* @__PURE__ */ jsx("button", { type: "submit", children: "Log Out Other Browser Sessions" }) })
          ] })
        ] })
      ] })
    ] })
...
function TwoFactorAuthentication({ requiresConfirmation }) {
  var _a;
  const { auth } = usePage().props;
  ...
  const handleRegenerate = async () => {
    try {
      ...
      const { data: data2 } = await axios.get(route("two-factor.recovery-codes"));
      setRecoveryCodes(data2);
    } catch (error) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsx(HeadingSmall, { title: "Security", description: "Enable extra security for your account." }),
    /* @__PURE__ */ jsx(Separator, {}),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Label, { asChild: true, children: /* @__PURE__ */ jsx("p", { children: "Two Factor Authentication" }) }),
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground py-2 text-sm", children: "When two-factor authentication is enabled, you will be prompted for a secure token during authentication. Retrieve this from your phone's authenticator app." })
      ] }),
      !twoFactorEnabled ? /* @__PURE__ */ jsx(Button, { onClick: handleEnable, disabled: processing, children: "Enable" }) : /* @__PURE__ */ jsx(Button, { variant: "destructive", onClick: handleDisable, disabled: processing, children: "Disable" })
    ] }),
    twoFactorEnabled && qrCode && /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
      /* @__PURE__ */ jsx(InputError, { message: (_a = errors.confirmTwoFactorAuthentication) == null ? void 0 : _a.code }),
      /* @__PURE__ */ jsx("p", { className: "text-muted-foreground py-2 text-sm", children: "Scan the QR code or enter the setup key into your authenticator app." }),
      /* @__PURE__ */ jsx("div", { dangerouslySetInnerHTML: { __html: qrCode } }),
      setupKey && /* @__PURE__ */ jsxs("p", { children: [
        "Setup Key: ",
        setupKey
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleConfirm, className: "flex items-end gap-2", children: [
        ...
        /* @__PURE__ */ jsx(Button, { type: "submit", variant: "outline", disabled: processing, children: "Confirm" })
      ] })
    ] }),
    twoFactorEnabled && recoveryCodes.length > 0 && /* @__PURE__ */ jsxs(Fragment$1, { children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(Label, { children: "Recovery Codes" }),
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground py-2 text-sm", children: "Store these recovery codes securely. They can help if you lose access." }),
        /* @__PURE__ */ jsx("ul", { className: "bg-muted rounded-md p-4", children: recoveryCodes.map((code) => /* @__PURE__ */ jsx("li", { children: code }, code)) })
      ] }),
      /* @__PURE__ */ jsx(Button, { onClick: handleRegenerate, disabled: processing, children: "Regenerate Recovery Codes" })
    ] })
  ] });
}
const breadcrumbs$1 = [
...
function Security({ sessions, requiresConfirmation }) {
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs: breadcrumbs$1, children: [
    /* @__PURE__ */ jsx(Head, { title: "Security" }),
    /* @__PURE__ */ jsxs(SettingsLayout, { children: [
      /* @__PURE__ */ jsx(TwoFactorAuthentication, { requiresConfirmation }),
      /* @__PURE__ */ jsx(BrowserSessions, { sessions })
    ] })
  ] });
}
...
function Storage({ url }) {
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-1 flex-col gap-4 rounded-xl p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid auto-rows-min gap-4 md:grid-cols-3", children: [
        /* @__PURE__ */ jsx("div", { className: "border-sidebar-border/70 dark:border-sidebar-border relative aspect-video overflow-hidden rounded-xl border", children: /* @__PURE__ */ jsx(Button, { asChild: true, variant: "link", children: /* @__PURE__ */ jsx("a", { href: url, children: "View" }) }) }),
        /* @__PURE__ */ jsx("div", { className: "border-sidebar-border/70 dark:border-sidebar-border relative aspect-video overflow-hidden rounded-xl border", children: /* @__PURE__ */ jsx(PlaceholderPattern, { className: "absolute inset-0 size-full stroke-neutral-900/20 dark:stroke-neutral-100/20" }) }),
        /* @__PURE__ */ jsx("div", { className: "border-sidebar-border/70 dark:border-sidebar-border relative aspect-video overflow-hidden rounded-xl border", children: /* @__PURE__ */ jsx(PlaceholderPattern, { className: "absolute inset-0 size-full stroke-neutral-900/20 dark:stroke-neutral-100/20" }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "border-sidebar-border/70 dark:border-sidebar-border relative min-h-[100vh] flex-1 rounded-xl border md:min-h-min", children: /* @__PURE__ */ jsx(PlaceholderPattern, { className: "absolute inset-0 size-full stroke-neutral-900/20 dark:stroke-neutral-100/20" }) })
...
const Ziggy = { "url": "http://daily.test", "port": null, "defaults": {}, "routes": { "login": { "uri": "login", "methods": ["GET", "HEAD"] }, "login.store": { "uri": "login", "methods": ["POST"] }, "logout": { "uri": "logout", "methods": ["POST"] }, "password.request": { "uri": "forgot-password", "methods": ["GET", "HEAD"] }, "password.reset": { "uri": "reset-password/{token}", "methods": ["GET", "HEAD"], "parameters": ["token"] }, "password.email": { "uri": "forgot-password", "methods": ["POST"] }, "password.update": { "uri": "settings/password", "methods": ["PUT"] }, "register": { "uri": "register", "methods": ["GET", "HEAD"] }, "register.store": { "uri": "register", "methods": ["POST"] }, "verification.notice": { "uri": "email/verify", "methods": ["GET", "HEAD"] }, "verification.verify": { "uri": "email/verify/{id}/{hash}", "methods": ["GET", "HEAD"], "parameters": ["id", "hash"] }, "verification.send": { "uri": "email/verification-notification", "methods": ["POST"] }, "user-profile-information.update": { "uri": "user/profile-information", "methods": ["PUT"] }, "user-password.update": { "uri": "user/password", "methods": ["PUT"] }, "password.confirm": { "uri": "user/confirm-password", "methods": ["GET", "HEAD"] }, "password.confirmation": { "uri": "user/confirmed-password-status", "methods": ["GET", "HEAD"] }, "password.confirm.store": { "uri": "user/confirm-password", "methods": ["POST"] }, "two-factor.login": { "uri": "two-factor-challenge", "methods": ["GET", "HEAD"] }, "two-factor.login.store": { "uri": "two-factor-challenge", "methods": ["POST"] }, "two-factor.enable": { "uri": "user/two-factor-authentication", "methods": ["POST"] }, "two-factor.confirm": { "uri": "user/confirmed-two-factor-authentication", "methods": ["POST"] }, "two-factor.disable": { "uri": "user/two-factor-authentication", "methods": ["DELETE"] }, "two-factor.qr-code": { "uri": "user/two-factor-qr-code", "methods": ["GET", "HEAD"] }, "two-factor.secret-key": { "uri": "user/two-factor-secret-key", "methods": ["GET", "HEAD"] }, "two-factor.recovery-codes": { "uri": "user/two-factor-recovery-codes", "methods": ["GET", "HEAD"] }, "sanctum.csrf-cookie": { "uri": "sanctum/csrf-cookie", "methods": ["GET", "HEAD"] }, "home": { "uri": "/", "methods": ["GET", "HEAD"] }, "dashboard": { "uri": "dashboard", "methods": ["GET", "HEAD"] }, "appearance": { "uri": "settings/appearance", "methods": ["GET", "HEAD"] }, "profile.edit": { "uri": "settings/profile", "methods": ["GET", "HEAD"] }, "profile.update": { "uri": "settings/profile", "methods": ["PATCH"] }, "profile.destroy": { "uri": "settings/profile", "methods": ["DELETE"] }, "password.edit": { "uri": "settings/password", "methods": ["GET", "HEAD"] }, "security.edit": { "uri": "settings/security", "methods": ["GET", "HEAD"] }, "security.update": { "uri": "settings/security", "methods": ["PUT"] }, "other-browser-sessions.destroy": { "uri": "user/other-browser-sessions", "methods": ["DELETE"] }, "current-user-photo.destroy": { "uri": "user/profile-photo", "methods": ["DELETE"] }, "current-user.destroy": { "uri": "user", "methods": ["DELETE"] }, "teams.create": { "uri": "teams/create", "methods": ["GET", "HEAD"] }, "teams.store": { "uri": "teams", "methods": ["POST"] }, "teams.show": { "uri": "teams/{team}", "methods": ["GET", "HEAD"], "parameters": ["team"] }, "teams.update": { "uri": "teams/{team}", "methods": ["PUT"], "parameters": ["team"] }, "teams.destroy": { "uri": "teams/{team}", "methods": ["DELETE"], "parameters": ["team"] }, "current-team.update": { "uri": "current-team", "methods": ["PUT"] }, "team-members.store": { "uri": "teams/{team}/members", "methods": ["POST"], "parameters": ["team"] }, "team-members.update": { "uri": "teams/{team}/members/{user}", "methods": ["PUT"], "parameters": ["team", "user"] }, "team-members.destroy": { "uri": "teams/{team}/members/{user}", "methods": ["DELETE"], "parameters": ["team", "user"] }, "team-invitations.accept": { "uri": "team-invitations/{invitation}", "methods": ["GET", "HEAD"], "parameters": ["invitation"] }, "team-invitations.destroy": { "uri": "team-invitations/{invitation}", "methods": ["DELETE"], "parameters": ["invitation"] }, "storage.local": { "uri": "storage/{path}", "methods": ["GET", "HEAD"], "wheres": { "path": ".*" }, "parameters": ["path"] } } };
  ...
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({
        ...
        "./pages/auth/two-factor-challenge.tsx": __vite_glob_0_5,
        "./pages/auth/verify-email.tsx": __vite_glob_0_6,
        "./pages/dashboard.tsx": __vite_glob_0_7,
        "./pages/settings/appearance.tsx": __vite_glob_0_8,
        "./pages/settings/general.tsx": __vite_glob_0_9,
        "./pages/settings/password.tsx": __vite_glob_0_10,
        "./pages/settings/security.tsx": __vite_glob_0_11,
        "./pages/storage.tsx": __vite_glob_0_12,
